/* 2017. 7. 31
 ...
 2 * 2 矩陣轉為 1 * 4 之後， 變為 1 row 4 column 分別填入 [1,2,3,4]
...
/* 第一次解題 : 142 ms
 ...
 將原矩陣鋪成 (flat) 單個 Array， 確保 flatArray 的元素數量 = R * C ，否則就直接返回原矩陣。
 
 用巢狀迴圈先建立每個 Row， 再對每個 Row 依序塞進位在 flatArray 的元素，最後輸出。
